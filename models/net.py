...
def init_vgg16(model_folder):
    ...
    if not os.path.exists(os.path.join(model_folder, 'vgg16.weight')):
        ...
        model_path = os.path.join(model_folder, 'vgg16.t7')
        vgglua = torchfile.load(model_path)
        # TODO:Test
        print("--------net.init_vgg16:" + model_path)
        #print(type(vgglua.modules))
        for cur_module in vgglua.modules:
            print(type(cur_module._obj))
        vgg = Vgg16()
